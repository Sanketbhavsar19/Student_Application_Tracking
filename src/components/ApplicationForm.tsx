...
import { submitApplication, StudentApplication } from '../lib/api';
...
export default function ApplicationForm({ onSuccess }: ApplicationFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await submitApplication(formData as Omit<StudentApplication, 'id' | 'created_at' | 'submitted_at' | 'application_status'>);
